      ...
      <main className="w-full relative flex-1 flex flex-col z-10 pb-[300px] lg:pb-0">
        <section>
          <div className="max-w-7xl mx-auto px-5 md:px-8 lg:px-10">
            <h1 className="text-3xl md:text-4xl lg:text-5xl font-black text-black text-center py-12 lg:py-16">Decisões Tecnológicas Mais Inteligentes</h1>
          </div>
        </section>
        <section className="max-w-7xl w-full mx-auto px-5 md:px-8 lg:px-10">
          <div className="max-w-4xl relative lg:pl-10">
              <h2 className="text-xl lg:text-2xl italic text-black mb-6 lg:mb-8 text-center lg:text-left leading-relaxed">Pare de adivinhar. Comece a decidir com estratégia.</h2>
              <p className="text-base lg:text-lg text-black leading-relaxed text-center lg:text-left">Implementamos as melhores tecnologias para reduzir riscos, otimizar processos e garantir vantagem competitiva no mercado digital.</p>
            </div>
        </section>
        <div className="flex justify-center lg:pl-20 mt-8 lg:mt-10 w-full relative z-30">
          <a href="https://wa.me/558299767685?text=Ol%C3%A1!%20Vim%20pelo%20site%20da%20Rocket%20Jr.%20e%20gostaria%20de%20agendar%20uma%20conversa%20com%20um%20especialista%20da%20equipe.">
            <button className="bg-gradient-to-r from-[#530101] via-[#750404] to-[#fd0404] text-white px-6 py-3 lg:px-10 lg:py-4 rounded-md font-bold uppercase tracking-widest text-xs lg:text-sm transition-all duration-300 hover:scale-105 hover:shadow-xl active:scale-95">Falar com um especialista</button>
          </a>
        </div>
      </main>
