...
export const metadata: Metadata = {
  ...
  description:
    "Modernizamos processos e integramos sistemas para tornar sua empresa mais ágil, eficiente e preparada para escalar.",
  alternates: {
        ...
        <section className="max-w-7xl w-full mx-auto px-5 md:px-8 lg:px-10">
          <div className="max-w-4xl relative lg:pl-10">
              <h2 className="text-xl lg:text-2xl italic text-black dark:text-white mb-6 lg:mb-8 text-center lg:text-left leading-relaxed">
                Modernize hoje para crescer amanhã.
                </h2>
              <p className="text-base lg:text-lg text-black dark:text-white leading-relaxed text-center lg:text-left">
                Automatizamos processos, integramos sistemas e preparamos sua empresa para escalar com eficiência, agilidade e segurança.
                </p>
            </div>
        </section>
        <div className="flex justify-center lg:pl-20 mt-8 lg:mt-10 w-full relative z-30">
            <a href="https://wa.me/5582996940657?text=Ol%C3%A1!%20Vim%20pelo%20site%20da%20Rocket%20Jr.%20e%20gostaria%20de%20saber%20mais%20sobre%20como%20iniciar%20a%20transforma%C3%A7%C3%A3o%20digital%20da%20minha%20empresa" rel="noopener noreferrer">
            <button type="button" className="bg-gradient-to-r from-[#530101] via-[#750404] to-[#fd0404] text-white px-6 py-3 lg:px-10 lg:py-4 rounded-md font-bold uppercase tracking-widest text-xs lg:text-sm transition-all duration-300 hover:scale-105 hover:shadow-xl active:scale-95">Iniciar transformação digital</button>
            </a>
        </div>
      </main>
