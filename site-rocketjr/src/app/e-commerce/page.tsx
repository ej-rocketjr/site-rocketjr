...
export const metadata: Metadata = {
  title: "E-commerce",
  description:
    "Criamos e-commerces focados em conversão, performance e experiência do usuário para aumentar suas vendas.",
  alternates: {
        ...
        <section>
          <div className="max-w-7xl mx-auto px-5 md:px-8 lg:px-10">
            <h1 className="text-3xl md:text-4xl lg:text-5xl font-black text-black dark:text-white text-center py-12 lg:py-16">
                E-commerces Prontos para Vender Mais
                </h1>
          </div>
        </section>
        <section className="max-w-7xl w-full mx-auto px-5 md:px-8 lg:px-10">
          <div className="max-w-4xl relative lg:pl-10">
              <h2 className="text-xl lg:text-2xl italic text-black dark:text-white mb-6 lg:mb-8 text-center lg:text-left leading-relaxed">
                Seu e-commerce precisa vender — não apenas existir.
                </h2>
              <p className="text-base lg:text-lg text-black dark:text-white leading-relaxed text-center lg:text-left">
                Criamos lojas virtuais focadas em conversão, performance e experiência do usuário, transformando visitas em vendas recorrentes.
                </p>
            </div>
        </section>
        <div className="flex justify-center lg:pl-20 mt-8 lg:mt-10 w-full relative z-30">
          <a href="https://wa.me/5582996940657?text=Ol%C3%A1!%20Vim%20pelo%20site%20da%20Rocket%20Jr.%20e%20tenho%20interesse%20em%20saber%20como%20voc%C3%AAs%20podem%20me%20ajudar%20a%20aumentar%20minhas%20vendas" rel="noopener noreferrer">
