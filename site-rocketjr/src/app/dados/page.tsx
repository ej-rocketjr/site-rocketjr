        ...
        <section>
          <div className="max-w-7xl mx-auto px-5 md:px-8 lg:px-10">
            <h1 className="text-3xl md:text-4xl lg:text-5xl font-black text-black dark:text-white text-center py-12 lg:py-16">
                Dados que Guiam Decisões Lucrativas
                </h1>
          </div>
        </section>
        <section className="max-w-7xl w-full mx-auto px-5 md:px-8 lg:px-10">
          <div className="max-w-4xl relative lg:pl-10">
              <h2 className="text-xl lg:text-2xl italic text-black dark:text-white mb-6 lg:mb-8 text-center lg:text-left leading-relaxed">
                Dados certos. Decisões mais lucrativas.
                </h2>
              <p className="text-base lg:text-lg text-black dark:text-white leading-relaxed text-center lg:text-left">
                Transformamos dados brutos em insights estratégicos que orientam decisões inteligentes e aumentam a performance do seu negócio.
                </p>
            </div>
        </section>
        <div className="flex justify-center lg:pl-20 mt-8 lg:mt-10 w-full relative z-30">
          <a href="https://wa.me/5582996940657?text=Ol%C3%A1!%20Vim%20pelo%20site%20da%20Rocket%20Jr.%20e%20gostaria%20de%20entender%20como%20voc%C3%AAs%20podem%20contribuir%20com%20insights%20estrat%C3%A9gicos%20para%20o%20meu%20neg%C3%B3cio" rel="noopener noreferrer">
            <button type="button" className="bg-gradient-to-r from-[#530101] via-[#750404] to-[#fd0404] text-white px-6 py-3 lg:px-10 lg:py-4 rounded-md font-bold uppercase tracking-widest text-xs lg:text-sm transition-all duration-300 hover:scale-105 hover:shadow-xl active:scale-95">Ver insights estratégicos</button>
          </a>
        </div>
      </main>
