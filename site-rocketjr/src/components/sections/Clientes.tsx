...
import linktreeRaquel from '@/assets/images/Linktree-Raquel-Paulina_nossos_clientes.svg';
import linktreeEduardo from '@/assets/images/Linktree-Eduardo-Palmeira_nossos_clientes.svg';
